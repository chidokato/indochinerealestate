                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input value="{{$data->price?$data->price:''}}" type="text" name="price" class="form-control price-input" placeholder="Từ (mặc định)">
                                <input value="{{$data->price_max?$data->price_max:''}}" type="text" name="price_max" class="form-control price-input" placeholder="Đến">
                            </div>
                        </div>
                    </div>
